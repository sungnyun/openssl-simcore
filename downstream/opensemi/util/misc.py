...
__all__ = ['AverageMeter', 'AverageClassMeter', 'adjust_lr_wd', 'warmup_learning_rate', 'ModelEMA', 'accuracy', 'update_metric', 'get_best_acc', 'save_model', 'update_json']
...
class ModelEMA(object):
    def __init__(self, model, decay):
        ...
        self.decay = decay
        self.ema_has_module = hasattr(self.model, 'module')
