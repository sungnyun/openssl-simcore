...
__all__ = ['AverageMeter', 'AverageClassMeter', 'adjust_lr_wd', 'warmup_learning_rate', 'get_params_groups', 'clip_gradients', 'cancel_gradients_prototypes', 'cancel_gradients_last_layer', 'accuracy', 'update_metric', 'get_best_acc', 'save_model', 'update_json']
...
# for SwAV
def cancel_gradients_prototypes(epoch, model, freeze_prototypes):
    if epoch > freeze_prototypes:
        return
